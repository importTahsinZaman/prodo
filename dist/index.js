...
function addXP(xpAmount) {
  ...
  while (current_pet_xp >= (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getNeededXp)(current_pet_level + 1)) {
    current_pet_xp = current_pet_xp - (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getNeededXp)(current_pet_level + 1);
    current_pet_level += 1;
  }
  ...
  chrome.storage.sync.set(
    {
      [current_pet]: {
        ...
        needed_xp: (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getNeededXp)(current_pet_level + 1),
      },
    },
    (r) => {
